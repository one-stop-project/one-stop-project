...
class OrderCancelHistoryTest {
    ...
    void createOrderCancelHistory_fail_whenActorTypeIsNull() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_032);
    }
    ...
    void createOrderCancelHistory_fail_whenCancelTypeIsNull() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_033);
    }
    ...
    void createOrderCancelHistory_fail_whenRequiredActorIdIsNull() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_034);
    }
    ...
    void createOrderCancelHistory_fail_whenUnnecessaryActorIdExists() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_035);
    }
    ...
    void createOrderCancelHistory_fail_whenActorIdIsLessThanOne() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_036);
    }
    ...
    void createOrderCancelHistory_fail_whenCancelledPriceIsNull() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_037);
    }
    ...
    void createOrderCancelHistory_fail_whenRestoredPointIsNull() {
        ...
        // then
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.ORDER_038);
    }
